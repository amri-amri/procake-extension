...
public class SMSanchezICD10CMImpl extends SMSanchez implements SMSanchezICD10CM {
    @Override
    ...
    public Similarity compute(DataObject dataObject1, DataObject dataObject2, SimilarityValuator similarityValuator) {
        ...
        try {
             ...
             value = computeSimilarity(Taxonomy.ICD_10_CM, code1, code2);
